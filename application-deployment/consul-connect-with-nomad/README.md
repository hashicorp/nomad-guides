...
An overview of Docker's bridge, host and other network modes can be found on [Docker Network driver documentation](https://docs.docker.com/network/#network-drivers).
