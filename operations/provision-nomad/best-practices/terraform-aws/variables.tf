...
variable "bastion_release"        { default = "0.1.0-beta1" }
variable "bastion_consul_version" { default = "1.0.6" }
variable "bastion_vault_version"  { default = "0.9.6" }
variable "bastion_nomad_version"  { default = "0.7.1" }
...
# Consul Variables
# ---------------------------------------------------------------------------------------------------------------------
variable "consul_release"    { default = "0.1.0-beta1" }
...
variable "vault_release"    { default = "0.1.0-beta1" }
...
# Nomad Variables
# ---------------------------------------------------------------------------------------------------------------------
variable "nomad_release"    { default = "0.1.0-beta1" }
