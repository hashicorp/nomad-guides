...
bastion_release        = "0.1.0-dev1" # Release version tag (e.g. 0.1.0, 0.1.0-rc1, 0.1.0-beta1, 0.1.0-dev1)
bastion_consul_version = "1.0.6-ent" # Consul version tag (e.g. 1.0.6 or 1.0.6-ent) - https://releases.hashicorp.com/consul/
bastion_vault_version  = "0.9.6-ent" # Vault version tag (e.g. 0.9.6 or 0.9.6-ent) - https://releases.hashicorp.com/vault/
bastion_nomad_version  = "0.7.1-ent" # Nomad version tag (e.g. 0.7.1 or 0.7.1-ent) - https://releases.hashicorp.com/nomad/
...
# Consul Variables
# ---------------------------------------------------------------------------------------------------------------------
consul_release    = "0.1.0-dev1" # Release version tag (e.g. 0.1.0, 0.1.0-rc1, 0.1.0-beta1, 0.1.0-dev1)
consul_version    = "1.0.6-ent" # Consul version tag (e.g. 1.0.6 or 1.0.6-ent) - https://releases.hashicorp.com/consul/
...
vault_release    = "0.1.0-dev1" # Release version tag (e.g. 0.1.0, 0.1.0-rc1, 0.1.0-beta1, 0.1.0-dev1)
vault_version    = "0.9.6-ent" #  Version tag (e.g. 0.9.6 or 0.9.6-ent) - https://releases.hashicorp.com/vault/
...
# Nomad Variables
# ---------------------------------------------------------------------------------------------------------------------
nomad_release    = "0.1.0-dev1" # Release version tag (e.g. 0.1.0, 0.1.0-rc1, 0.1.0-beta1, 0.1.0-dev1)
nomad_version    = "0.7.1-ent" # Nomad version tag (e.g. 0.7.1 or 0.7.1-ent) - https://releases.hashicorp.com/nomad/
